        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-lg-6 mb-5 mb-lg-0">
            <div class="block text-center text-lg-start pe-0 pe-xl-5">
              ...
              <p class="mb-4">{{ $config->detail }}</p> <a type="button" class="btn" style="background-color: #00aaff; color: white;" href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">See More
          ...
          <div class="col-lg-6">
            <div class="ps-lg-5 text-center">
              <img 
                loading="lazy"
                decoding="async"
                src="{{ asset ('front/assets/pocoyo2.jpg') }}"
                alt="banner image" class="w-80">
            </div>
          </div>
        </div>
      </div>
